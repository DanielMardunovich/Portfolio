...
export const TILES = [
  //Full grass tiles
  { id: "grass_empty", sx: 0, sy: 0, weight: 120, walkCost: 1, spawnable: true },
  { id: "grass_grass", sx: 1, sy: 0, weight: 90, walkCost: 1, spawnable: true },
  ...
  { id: "river_connectsgrass_tl", sx: 3, sy: 0, weight: 2, walkCost: 3, spawnable: false },

  //River Tiles R
  { id: "river_connectsgrass_tr", sx: 4, sy: 0, weight: 2, walkCost: 3, spawnable: false },
  { id: "river_connectsgrass_br", sx: 4, sy: 1, weight: 2, walkCost: 3, spawnable: false },

  //River Tiles C
  { id: "river_connectsgrass_tb", sx: 1, sy: 4, weight: 6, walkCost: 3, spawnable: false },
  { id: "river_connectsgrass_lr", sx: 3, sy: 3, weight: 6, walkCost: 3, spawnable: false },
  
   //River Endings
  { id: "river_connectsgrass_tbl", sx: 6, sy: 1, weight: 0.05, walkCost: 3, spawnable: false },
  { id: "river_connectsgrass_tbr", sx: 6, sy: 0, weight: 0.05, walkCost: 3, spawnable: false },
  { id: "river_connectsgrass_trl", sx: 5, sy: 0, weight: 0.05, walkCost: 3, spawnable: false },
  { id: "river_connectsgrass_brl", sx: 5, sy: 1, weight: 0.05, walkCost: 3, spawnable: false },

  //Bridges
  { id: "bridge_lr", sx: 4, sy: 7, weight: 0, walkCost: 1, spawnable: true },
  { id: "bridge_tb", sx: 4, sy: 9, weight: 0, walkCost: 1, spawnable: true },
...
[
  ...
  { id: "arrow_helper_ld", sx: 6, sy: 3},
  { id: "arrow_helper_ul", sx: 6, sy: 4},
  { id: "arrow_helper_ur", sx: 5, sy: 4},
  { id: "arrow_helper_dr", sx: 5, sy: 3},
